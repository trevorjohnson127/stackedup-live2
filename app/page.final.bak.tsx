      ...
      case 'portfolio':
        return (
          <div className="bg-white p-6 rounded-xl shadow-xl mt-6 w-3/4 mx-auto text-center">
            <h2 className="text-lg font-bold text-green-700">📊 Portfolio Overview</h2>
            <p className="text-sm mt-2 text-gray-700">This will show your active investments, gain/loss, and performance summary.</p>
          </div>
        );
      case 'checksheet':
        return (
          <div className="bg-white p-6 rounded-xl shadow-xl mt-6 w-3/4 mx-auto text-center">
            ...
            <p className="text-sm mt-2 text-gray-700">This will show the checklist interaction panel. Pull dynamic questions soon.</p>
          </div>
        );
      case 'alerts':
        return (
          <div className="bg-white p-6 rounded-xl shadow-xl mt-6 w-3/4 mx-auto text-center">
            <h2 className="text-lg font-bold text-yellow-600">🔔 Alerts</h2>
            <p className="text-sm mt-2 text-gray-700">This will display system alerts, triggers, and notices based on your portfolio.</p>
          </div>
        );
      default:
        return null;
      ...
      <div className="flex-1 ml-20 p-10 overflow-y-auto">
        ...
        <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 flex gap-6 z-50">
          <button
            ...
            className="bg-white rounded-full px-6 py-3 shadow-md hover:shadow-xl transition text-black font-semibold"
          >
            📊 Portfolio
          </button>
          <button
